...
public class EmailServiceImplementation implements EmailService {
	...
	public void sendHtmlEmailWithEmbeddedFiles(String name, String to, String token) {
		...
		try {
			...
			// First part - message
			BodyPart messageBodyPart1 = new MimeBodyPart(); // BodyPart is an Abstract class that extends BodyPart
	...
	@Override
	public void adminResponse(String userName, String to, String token) {
